...
exports.BasePage = exports.IdentificationType = void 0;
...
(function (IdentificationType) {
    ...
    IdentificationType[IdentificationType["NgModel"] = 7] = "NgModel";
...
var BasePage = /** @class */ (function () {
    ...
    BasePage.prototype.ElementLocator = function (obj) {
        switch (obj.type) {
            ...
            case IdentificationType[IdentificationType.NgModel]:
                return protractor_1.element(protractor_1.by.NgModel(obj.value));
            default:
                break;
        }
    };
